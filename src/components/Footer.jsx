        ...
        <div className="footer-wrapper">
            <footer>
                <div className="footer-row logo-row">
                    <img loading='lazy' className="footer-logo beet-logo" src="/logos/beet.png" alt="Logo" />
                    <img loading='lazy' className="footer-logo" src="/logos/signature2.jpg" alt="Beet Signature"/>
                </div>
                ...
                <div className="footer-row footer-row-content">
                    <div className="footer-col">
                        ...
                        <img loading='lazy' className="footer-logo" src="/logos/SupportLocal.jpg" alt="Support Local" />
                    </div>
